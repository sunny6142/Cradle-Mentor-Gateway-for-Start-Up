                                                                        ...
                                                                        <!--- ---- -->
                                                                            <section>
                                                                                ...
                                                                                <div class="form-group row add">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <input type="text" class="form-control" id="numberoffounder" name="numberoffounder" placeholder="Enter Number Founder Your Start Up Has" required>
                                                                        ...
                                                                        <section id="innerstep2"></section>
                                                                            ...
                                                                            <script>
                                                                                    ...
                                                                                    function showstep2() {
                                                                                        ...
                                                                                        console.log({{count($founders)}});
                                                                                        console.log('{{$founders}}');
                                                                                        
                                                                                        if(n == {{count($founders)}}) console.log("OK");
                                                                                        ...
                                                                                        @foreach($founders as $fou)
                                                                                            ...
                                                                                            $("#innerstep2").append('<p>Founder '+ (Number(i) + Number(1)) +' </p><div class="form-group row">' + 
                                                                                                '<label class="control-label col-sm-4 pt-2" for="fname">Name Of Founder :</label>' +
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text" class="form-control" id="fname" name="fname[]" placeholder="Enter Name here" value = "{{$fou->name}}">'+
                                                                                            ...
                                                                                            '<div class="form-group row">' +
                                                                                                ...
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text" class="form-control" id="fdesignation" name="fdesignation[]" placeholder="Enter Designation here" value = "{{$fou->designation}}">' +
                                                                                            ...
                                                                                            '<div class="form-group row">' +
                                                                                                ...
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text" class="form-control" id="fmobile" name="fmobile[]" placeholder="Enter Mobile no. here" value = "{{$fou->contact}}">' +
                                                                                            ...
                                                                                            ' <label class="control-label col-sm-4 pt-2" for="femail">Email Id :</label>' +
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text"  class="form-control" id="femail" name="femail[]" placeholder="Enter Email Id here" value = "{{$fou->email_id}}">' +
                                                                                        ...
                                                                                        while(Number(i) < Number(n))
                                                                                        {
                                                                                             $("#innerstep2").append('<p>Founder '+ (Number(i) + Number(1)) +' </p><div class="form-group row">' + 
                                                                                                '<label class="control-label col-sm-4 pt-2" for="fname">Name Of Founder :</label>' +
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text" class="form-control" id="fname" name="fname[]" placeholder="Enter Name here" value = "">'+
                                                                                                    '<p class="name_error text-center alert alert-danger hidden"></p>'+
                                                                                                '</div>' +
                                                                                            '</div>' +
                                                                                            '<div class="form-group row">' +
                                                                                                '<label class="control-label col-sm-4 pt-2" for="fdesignation">Designation :</label>' +
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text" class="form-control" id="fdesignation" name="fdesignation[]" placeholder="Enter Designation here" value = "">' +
                                                                                                    '<p class="fdesignation_error text-center alert alert-danger hidden"></p>' +
                                                                                                '</div>' +
                                                                                            '</div>' +
                                                                                            '<div class="form-group row">' +
                                                                                                '<label class="control-label col-sm-4 pt-2" for="fmobile">Mobile no :</label>' +
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text" class="form-control" id="fmobile" name="fmobile[]" placeholder="Enter Mobile no. here" value = "">' +
                                                                                                    '<p class="fmobile_error text-center alert alert-danger hidden"></p>' +
                                                                                                '</div>' +
                                                                                            '</div>' +
                                                                                            ...
                                                                                            ' <label class="control-label col-sm-4 pt-2" for="femail">Email Id :</label>' +
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text"  class="form-control" id="femail" name="femail[]" placeholder="Enter Email Id here" value = "">' +
                                                                                                    '<p class="femail_error text-center alert alert-danger hidden"></p>' +
                                                                                                '</div>' +
                                                                                            '</div>' +
                                                                                            '<div class="form-group row">' +
