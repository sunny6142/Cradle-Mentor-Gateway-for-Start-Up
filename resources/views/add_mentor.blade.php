                                                                                        ...
                                                                                        <!--- ---- -->
                                                                                            ...
                                                                                            <input type="text" hidden class="form-control hidden" id="mid" name="mid">
                                                                                                ...
                                                                                                <div class="form-group row add">
                                                                                                    ...
                                                                                                    <div class="col-sm-8">
                                                                                                        <input type="text" required class="form-control date_picker" id="mdob" name="mdob" placeholder="Mentor D.O.B" required>
                                                                                    ...
                                                                                    <div class="tab-pane pt-3" id="step5">
                                                                                        ...
                                                                                        <section>
                                                                                            ...
                                                                                            <div class="form-group row add ">
                                                                                                ...
                                                                                                <div class="col-sm-8">
                                                                                                    <input type="text" onfocus="Select()"  class="form-control" id="sdow" name="sdow" placeholder="Enter here" required>
                                                                                                    <div class="hidden selectfn" >
                                                                                                        <select onblur="Deselect()" class="selectpicker w-100" multiple data-live-search="true">
                                                                                                            <option onclick="clearme()" class="text-danger"><span>clear <i class="fa fa-remove"></i><span> </option>
                                                                                                            <option onclick="set('Sun')">Sunday</option>
                                                                                                            <option onclick="set('Mon')">Monday</option>
                                                                                                            <option onclick="set('Tue')">Tuesday</option>
                                                                                                            <option onclick="set('Wed')">Wednesday</option>
                                                                                                            <option onclick="set('Thu)">Thursday</option>
                                                                                                            <option onclick="set('Fri')">Friday</option>
                                                                                                            <option onclick="set('Sat')">Saturday</option>
                                                                                                        </select>
                                                                                                    </div>
                                                                                                    <script>
                                                                                                        var com = 1;
                                                                                                        ...
                                                                                                        function Deselect()
                                                                                                        {
                                                                                                            $('.selectfn').addClass('hidden');
                                                                                                        }
                                                                                                        function Select()
                                                                                                        {
                                                                                                            $('.selectfn').removeClass('hidden');
                                                                                                        }
                                                                                                    </script>
