        ...
        <div class="modal-content">
            ...
            <div class="card" style=";">
                <div class="view-approval" style="width:150px; height:150px; display: block;margin-left: auto; margin-right: auto;">
                    <img style="width:auto; height:150px" class="card-img-top img-fluid img-thumbnail" id="startuplogo" src="https://www.w3schools.com/w3images/lights.jpg" alt="Card image cap">
...
<script>
    ...
    function SDAT()
    {
         window.location.replace("/set/meeting/date/"+$('input[name^="request_m_id"]').val());
        // return;
...
<script>
    ...
    function approve(t){
        ...
        window.location.replace("/set/meeting/date/"+$('input[name^="starttime"]').val());
...
function viewdetil(val) 
{
    ...
    $("#startuplogo").attr("src","{{ asset('') }}public/images/"+val.logo);
