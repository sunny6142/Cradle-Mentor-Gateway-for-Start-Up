...
<link rel="stylesheet" href="{{ asset('starup/css/datepicker.css') }}" >
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('') }}public/images/download.png" class="profile-pic" /> 
                            {{ Auth::user()->name }}
                            </a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       ...
                       <!--<li> 
                        ...
                        <li> 
                            <a  href="{{route('list.mentor')}}" aria-expanded="false">
                                <i class="fa fa-bar-chart"></i>
                                <span class="hide-menu">Mentor</span>
                            </a>
                        </li>
                        <li> 
                            <a href="{{route('mentor.approval')}}" aria-expanded="false">
                                <i class="fa fa-envelope"></i>
                                <span class="hide-menu">Approval</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('list.startup')}}" aria-expanded="false">
                                <i class="fa fa-tachometer"></i>
                                <span class="hide-menu">Start Up</span>
                            </a>
                        </li>
...
<script src="{{ asset('starup/js/datepicker.js') }}" ></script>
    <!-- scripit init-->
