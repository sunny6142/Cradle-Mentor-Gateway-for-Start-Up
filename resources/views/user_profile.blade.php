                                ...
                                <div class="card-two">
                                    <header>
                                        <div class="avatar">
                                            ...
                                            @if(!empty($start_up_info[0]->logo))
                                            <img src="{{ asset('') }}public/images/{{ $start_up_info[0]->logo  }}" alt="{{ $start_up_info[0]->start_up_name }}" />
                                            @else
                                            <img src="{{ asset('public/images/download.png') }}" alt="user" class="{{ $start_up_info[0]->start_up_name }}" /> 
                                            @endif
                 ...
                 <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-two">
                                    <h4 class="text-success alert-success p-3">Profile data is not available</h4>
                                </div>
                            </div>
                        </div>
                    </div>
