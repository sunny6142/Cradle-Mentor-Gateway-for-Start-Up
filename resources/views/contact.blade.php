                ...
                <form method="post" action="/contact" id="contact-form">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label>Massage</label>
                            <textarea name="message" placeholder="" size="4"></textarea>
                        </div>
    ...
    <section class="map-section">
        <div class="outer-container">
			...
			<div class="map-canvas"
				...
				data-hue="#ffc400"
				data-title="Envato"
				data-icon-path="{{ asset('') }}public/welcome/images/icons/map-marker.png"
				data-content="Melbourne VIC 3000, Australia_3Cbr_3E_3Ca href='mailto_3Ainfo_40youremail.com'_3Einfo_40youremail.com_3C/a_3E">
			</div>
        </div>
    </section>
    <!--End Map Section -->
