...
<div class="pcoded-wrapper">
    <div class="pcoded-content">
        <div class="pcoded-inner-content">
            ...
            <div class="main-body">
                <div class="p-5">
                   @if($start_up_info->isEmpty() || $start_up_info[0]->how_know_about_us == null)
                                        <!-- Page-header start -->
                                                            ...
                                                            <form role="form" id="form2" class="w-95" style = "max-width: 600px; margin: 0 auto;">
                                                                <div class="tab-content">
                                                                        ...
                                                                        <!--- ---- -->
                                                                            <section>
                                                                                ...
                                                                                <div class="form-group row add">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <input type="text" required class="form-control" id="Address" name="Address" placeholder="Office Address" required>
                                                                                    ...
                                                                                    function showstep2() {
                                                                                        ...
                                                                                        for(i = 0; i < n; i++) {  
                                                                                            $("#innerstep2").append('<p>Founder '+ (+i + +1) +' </p><div class="form-group row">' + 
                                                                                                ...
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text" required class="form-control" id="fname" name="fname[]" placeholder="Enter Name here" required>'+
                                                                                            ...
                                                                                            '<div class="form-group row">' +
                                                                                                ...
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text" required class="form-control" id="fdesignation" name="fdesignation[]" placeholder="Enter Designation here" required>' +
                                                                                            ...
                                                                                            '<div class="form-group row">' +
                                                                                                ...
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text" required class="form-control" id="fmobile" name="fmobile[]" placeholder="Enter Mobile No. here" required>' +
                                                                                            ...
                                                                                            ' <label class="control-label col-sm-4 pt-2" for="femail">Email Id :</label>' +
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<input type="text" required class="form-control" id="femail" name="femail[]" placeholder="Enter Email Id here" required>' +
                                                                                            ...
                                                                                            '<div class="form-group row">' +
                                                                                                ...
                                                                                                '<div class="col-sm-8">' +
                                                                                                    '<select class="form-control" name="fqualification[]" id="fqualification" style="height: unset;" required>' +
                                                                                                    '<option id="val"> </option>' +
                                                                                                        @foreach ($qualification as $qual)
                                                                                                            '<option id="val" value = {{$qual->id}}> {{$qual->qualification}} </option>' +
                                                                                                        @endforeach
                                                                                                    '</select>' +
                                                                                                '</div>' +
                                                                                            '</div>');
                                                                    ...
                                                                    <div class="tab-pane" id="step3">
                                                                        <section>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-12">
                                                                                        <select class="form-control" onchange="changeipr()" style="width: 100%; float: right; max-width: 300px; height: inherit;" name="iprval" id="iprval" required>
                                                                                        <option id="val"> </option>
                                                                                            @foreach ($yn as $ynv)
                                                                                    ...
                                                                                    <script>
                                                                                        function changeipr()
                                                                                        {
                                                                                            if($('select[name=iprval]').val() == 1){
                                                                                                $("#iprd *").removeAttr("disabled")
                                                                                            }
                                                                                            else
                                                                                            $("#iprd *").attr("disabled", "disabled").off('click');
                                                                                        }
                                                                                    </script>
                                                                            </div>

                                                                            <div class="form-group row" id="iprd">        
                                                                            ...
                                                                            <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-12">
                                                                                        <select class="form-control" onchange="changeiv()"  style="width: 100%; float: right; max-width: 300px; height: inherit;" name="innovative_p" id="innovative_p" required>
                                                                                        <option id="val"> </option>
                                                                                            @foreach ($yn as $ynv2)
                                                                                    ...
                                                                                    <script>
                                                                                        function changeiv()
                                                                                        {
                                                                                            if($('select[name=innovative_p]').val() == 1){
                                                                                                $("#iv *").removeAttr("disabled")
                                                                                            }
                                                                                            else
                                                                                            $("#iv *").attr("disabled", "disabled").off('click');
                                                                                        }
                                                                                    </script>
                                                                                    
                                                                            </div>

                                                                            <div class="form-group row mt-4 mb-4" id="iv">
                                                                                <table class="table table-bordered">
                                                                                    <thead>
                                                                                        <tr>
                                                                    ...
                                                                    <div class="tab-pane" id="step5">
                                                                        ...
                                                                        <section>
                                                                            <div class="form-group row add">
                                                                                <label class="control-label col-sm-4 pt-2" for="revenue_any"> Revenue (if any, if no then enter 0) :</label>
                                                                                <div class="col-sm-8">
                                                                            ...
                                                                            <div class="form-group row add ">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <input type="text" required class="form-control date_picker" id="incubation_date" name="incubation_date" placeholder="Enter here" required>
                                                                    ...
                                                                    <div class="tab-pane" id="complete">
                                                                        ...
                                                                        <ul class="list-inline pull-right">
                                                                                ...
                                                                                <li><a href="/req/mentor" id="lreq" class="btn btn-warning hidden">Request Mentor</a></li>
                                                                        </ul>
                                                                    </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#submit_step2").click(function() {
            ...
            $("#innerstep2 input").each(function(){
               if ($.trim($(this).val()).length == 0){
                    $(this).addClass("border border-danger");
                    isFormValid = false;
                    $(this).focus(); 
                    $(this.nextElementSibling).removeClass("hidden");
                    $(this.nextElementSibling).text("Field Required");
                }
                else{
             ...
             $("#innerstep2 select").each(function(){
               if ($.trim($(this).val()).length == 0){
                    $(this).addClass("border border-danger");
                    isFormValid = false;
                    $(this).focus(); 
             ...
             $("#innerstep2").find('input[name^="fmobile"]').each(function(){
               ...
               if ($(this).val().match(phoneno) ){
                   console.log($(this).val().match(phoneno) );
              //      $(this.nextElementSibling).addClass("hidden");
              //      $(this).removeClass("border border-danger");
                }
                else{
                    ...
                    $(this).focus(); 
                    $(this.nextElementSibling).removeClass("hidden");
                    $(this.nextElementSibling).text("Enter a valid phone number.");
                }
            });
            
            $("#innerstep2").find('input[name^="femail"]').each(function(){
                
                var mailformat = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
                
                console.log("ss"+$(this).val().match(mailformat) );
            ...
            //        $(this).removeClass("border border-danger");
                    ...
                    $(this).focus(); 
                    $(this.nextElementSibling).removeClass("hidden");
                    $(this.nextElementSibling).text("Enter a valid email adddress.");
                }
            });
