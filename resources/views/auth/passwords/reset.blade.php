...
<div class="login-html">
    ...
    <div class="login-form">
        <div class="sign-in-htm">
			...
			<div class="group">
                <label for="cuser" class="label">Confirm Password</label>
                <input id="cuser" type="password" name="cpassword" class="input">
				<p class="text-danger" id="message"></p>
				<p class="text-success" id="smessage"></p>
            </div>
            <div class="group" >
                <button class="button btn btn-primary" id="forget">Change Password</button>
            </div>
            <div class="hr"></div>
			<div class="foot-lnk">
...
<script>
    ...
    $(document).ready(function(){
	 	...
	 	$("#forget").click(function(){
              ...
              console.log($('input[name=cpassword]').val());

              let p1 = $('input[name=password]').val();
              let p2 = $('input[name=cpassword]').val();
			...
			if($('input[name=password]').val() != $('input[name=cpassword]').val())
			{
                ...
                data.append('email', $('input[name=password]').val());
                ...
                $.ajax({
                   ...
                   success: function(data) {
                            if(data.errors){
                                ...
                                $('#forget').append('Change Password');
                            }
                            else{
                                $("#smessage").text('Password changed Successfully');
                                $('#forget').text(""); 
                                $('#forget').append('Changed');
