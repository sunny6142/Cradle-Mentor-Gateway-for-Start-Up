...
class MethodController extends Controller
{
    ...
    public function mentorevent()
    {
     ...
     //  ->select('request_mentor.*')
        ->where(['mentors.admins' => Auth::user()->id, 'mentors.mentor_status' =>2, 'mentors.user_status'=>2, 'day_and_time.approval' => 1,])
    ...
    public function deleteevent(Request $request)
    {
       // DB::transaction(function() use ($request) {
            ...
            ->update(['request_mentor_status' => 5]);  //cancel by mentor
