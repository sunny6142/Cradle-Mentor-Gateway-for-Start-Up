    ...
    */
    ...
    //    Session::put('last_auth_attempt', 'register');
        ...
        $validator = Validator::make($request->all(), [
            ...
            'email' => 'required|email|unique:users', //admins
                ...
                $msg = '<body style="padding:5px">Dear '.$request->name.',
                                          ...
                                          <br>Kindly find below the brief about it,<br><br>
                                            ...
                                            Click below link to Activate your account.<br>
                                             <a href="https://www.mentorgateway.com/active/'.$user->id.'/'.$val.'" target="_blank"> Click Here </a> <br>
                                          <br><br>
                                            Regards,<br>
                                            Team Mentorgateway<br>
                                          <a href=""https://www.mentorgateway.com" target="_blank"> www.mentorgateway.com </a> <br>
